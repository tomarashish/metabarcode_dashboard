    ...
    _selection.each(function (_data) {
      ...
      var taxonArc = svg.selectAll(".arc")
        ...
        .attr("class", function (d) {
          return "arc" + ' ' + taxonLevel.toLowerCase() + ' ' + d.data.TaxonomyName.replace(/\s+/g, '');
        });

      taxonArc.append("path")
        .attr("d", arc)
        .attr("id", function (d) {
          return taxonLevel.toLowerCase() + '-' + d.data.TaxonomyName.replace(/\s+/g, '_');
        })
        .style("fill", function (d) {
          return color(d.data.TaxonomyName);
        })
        .style("cursor", "hand")
